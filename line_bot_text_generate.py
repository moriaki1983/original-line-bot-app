...
def text_generate_from_analyze_result(line_spkr_nm, line_msg_txt, line_msg_intnt, prv_msgrcd_lst):
    ...
    if flw_of_uttrnc == "<称賛＆礼賛>":
       rply_msg_cnddt = [line_spkr_nm + "さん" + "ありがとうございます", "嬉しいです"]
    ...
    if flw_of_uttrnc == "<称賛＆礼賛><称賛＆礼賛><称賛＆礼賛>":
       rply_msg_cnddt = [line_spkr_nm + "さん" + "またまたまた～", "そう言われても何も出ませんよ 笑"]
       rply_msg = random.choice(rply_msg_cnddt)
       return rply_msg
    ...
    if flw_of_uttrnc == "<称賛＆礼賛><称賛＆礼賛><称賛＆礼賛><称賛＆礼賛><称賛＆礼賛>":
       rply_msg_cnddt = ["またまたまた～", line_spkr_nm + "さん" + "もうしょうがないな～ 付き合ってあげますよ 笑"]
       rply_msg = random.choice(rply_msg_cnddt)
       return rply_msg
    if flw_of_uttrnc == "<卑猥な言動 辱め>":
       rply_msg_cnddt = ["やめてください", "/ω＼)ｲﾔﾝ", line_spkr_nm + "さん" + "いやらしいですよね"]
       rply_msg = random.choice(rply_msg_cnddt)
       return rply_msg
    if flw_of_uttrnc == "<卑猥な言動 辱め><卑猥な言動 辱め>":
       rply_msg_cnddt = ["もうええわ", line_spkr_nm + "さん" + "そんなこと言ってると 女性に嫌われますよ"]
       rply_msg = random.choice(rply_msg_cnddt)
       return rply_msg
